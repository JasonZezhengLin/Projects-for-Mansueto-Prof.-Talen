...
- `chicago_gba_buildings.gpkg` (preferred full version)
- zipped shapefile export
- split GeoJSON parts

See `project1/Project1_Data_Access_Note.txt` for links and format notes.
...
- Project 1 and Project 2 delivery materials
